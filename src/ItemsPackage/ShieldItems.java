...
public class ShieldItems {
    ...
    public static Shield createShield1(){ //ID0
        shield=new Shield("Escudo de madera",10,50,10,50);
        return shield;
    }

    public static Shield createShield2(){//ID1
        shield=new Shield("Escudo de piedra",20,50,15,60);
        return shield;
    }

    public static Shield createShield3(){//ID2
        shield=new Shield("Escudo de bronce",30,50,20,70);
        return shield;
    }

    public static Shield createShield4(){//ID3
        shield=new Shield("Escudo de hierro",40,50,25,80);
        return shield;
    }

    public static Shield createShield5(){//ID4
        shield=new Shield("Escudo de acero",50,50,30,90);
        return shield;
    }

    public static Shield createShield6(){//ID5
        shield=new Shield("Escudo de fuego",100,50,60,150);
        return shield;
    }
